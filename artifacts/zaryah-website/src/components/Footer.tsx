  ...
  return (
    <footer style={{ background: "#0A0A0A", color: "#CCCCCC" }}>
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b" style={{ borderColor: "#2A2A2A" }}>
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-xs font-mono tracking-wider uppercase" style={{ color: "#666666" }}>
              India · UAE · Global
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm" style={{ color: "#999999" }}>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 space-y-2 text-sm" style={{ color: "#999999" }}>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs" style={{ color: "#666666" }}>
